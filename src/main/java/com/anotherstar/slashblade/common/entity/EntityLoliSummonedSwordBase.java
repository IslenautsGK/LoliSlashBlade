...
public class EntityLoliSummonedSwordBase extends EntitySummonedSwordBase {

	public EntityLoliSummonedSwordBase(World world) {
		super(world);
		alreadyHitEntity.add(this);
	}

	public EntityLoliSummonedSwordBase(World world, EntityLivingBase entity, float AttackLevel, float roll) {
		super(world, entity, AttackLevel, roll);
		alreadyHitEntity.add(this);
	}

	public EntityLoliSummonedSwordBase(World world, EntityLivingBase entity, float AttackLevel) {
