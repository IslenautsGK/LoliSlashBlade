...
public class EntityLoliHeavyRainSwords extends EntityHeavyRainSwords {

	public EntityLoliHeavyRainSwords(World world) {
		super(world);
	}

	public EntityLoliHeavyRainSwords(World world, EntityLivingBase entity, float AttackLevel, float roll, int interval,
			int targetId) {
		super(world, entity, AttackLevel, roll, interval, targetId);
	}

	public EntityLoliHeavyRainSwords(World world, EntityLivingBase entity, float AttackLevel) {
