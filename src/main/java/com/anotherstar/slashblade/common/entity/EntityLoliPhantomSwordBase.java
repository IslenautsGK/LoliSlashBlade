...
public class EntityLoliPhantomSwordBase extends EntityPhantomSwordBase {

	public EntityLoliPhantomSwordBase(World world) {
		super(world);
		alreadyHitEntity.add(this);
	}

	public EntityLoliPhantomSwordBase(World world, EntityLivingBase entity, float AttackLevel, float roll) {
		super(world, entity, AttackLevel, roll);
		alreadyHitEntity.add(this);
	}

	public EntityLoliPhantomSwordBase(World world, EntityLivingBase entity, float AttackLevel) {
