...
public class EntityLoliBlisteringSwords extends EntityBlisteringSwords {
	...
	public EntityLoliBlisteringSwords(World world, EntityLivingBase entity, float AttackLevel, float roll,
			int interval) {
		super(world, entity, AttackLevel, roll, interval);
	}

	public EntityLoliBlisteringSwords(World world, EntityLivingBase entity, float AttackLevel) {
